            ...
            return FadeInUp(
              ...
              child: Column(
                children: [
                  InkWell(
                    onTap: () {
                      Get.to(() => const StudentQestionPage(
                            subject: "Mathematics",
                          ));
                    },
                    child: Padding(
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(() => StudentQestionPage(
                            subject: snapshot.data?["electiveone"],
                          ));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(15.0),
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(() => StudentQestionPage(
                            subject: snapshot.data?["electivetwo"],
                          ));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(15.0),
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(() => StudentQestionPage(
                            subject: snapshot.data?["electivethree"],
                          ));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(15.0),
                  ...
                  InkWell(
                    onTap: () {
                      Get.to(() => StudentQestionPage(
                            subject: snapshot.data?["electivefour"],
                          ));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(15.0),
