...
class EditSchoolDetailsPage extends StatefulWidget {
  final String? name;
  final String? zone;
  final String? localgovernment;
  const EditSchoolDetailsPage(
      {super.key,
      @required this.name,
      @required this.zone,
  ...
  @override
  State<EditSchoolDetailsPage> createState() => _EditSchoolDetailsPageState();
}

class _EditSchoolDetailsPageState extends State<EditSchoolDetailsPage> {
                    ...
                    onTap: () async {
                      ...
                      try {
                        FirebaseFirestore.instance
                          ...
                          "schooldetails": true,
                          "schoolname":
                              schoolname.text.isEmpty || schoolname.text == ""
                                  ? widget.name
                                  : schoolname.text.trim(),
                          "schoolzone": selectedzone ?? widget.zone,
                          "localgovernment": localgov ?? widget.localgovernment
                        }).then((value) {
                          setState(() {
                            loading = false;
                          });
