...
class AdminTeacherDetailsPage extends StatefulWidget {
  ...
  @override
  State<AdminTeacherDetailsPage> createState() =>
      _AdminTeacherDetailsPageState();
}

class _AdminTeacherDetailsPageState extends State<AdminTeacherDetailsPage> {
  bool loading = false;
        ...
        actions: [
          InkWell(
            ...
            child: const Padding(
              ...
              child: ImageIcon(AssetImage("images/teacher.png"),
